      ...
      columns: [
        {
          ...
          //template: "{{update_datetime | date:'dd/MM/yyyy HH:mm:ss'}}"
            ...
            template: function (row, index, datatable) {
              ...
              return '\<a   href="javascript:navigate_edit(\''+ row.doc_type_code +'\')"  class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Review">\
          			<i class="flaticon-search"></i>\
          		</a>\
          		<a href="#" onclick="javascript:selectdel(\''+ row.doc_type_code +'\');return false;" data-toggle="modal" data-target="#m_modal_6" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Approve">\
